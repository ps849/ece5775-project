...
void readTextClassifier()//(myCascade * cascade)
{
  ...
  FILE *out_file = fopen("haar_data3.h","w");
...
fprintf(out_file, "int stages_array[%d] = {\n",TOTAL_STAGES);

for(int i=0;i<TOTAL_STAGES;i++)
{
  if(i!=TOTAL_STAGES-1)
    fprintf(out_file, "%d,",stages_array[i]);
  else 
    fprintf(out_file, "%d\n};\n",stages_array[i]);
}

fprintf(out_file, "int rectangles_array[%d] = {\n",TOTAL_COORDINATES);

for(int i=0;i<TOTAL_COORDINATES;i++)
{
  if(i!=TOTAL_COORDINATES-1)
    fprintf(out_file, "%d,",rectangles_array[i]);
  else 
    fprintf(out_file, "%d\n};\n",rectangles_array[i]);
}

fprintf(out_file, "int rectangles_array0[%d] = {\n",9*12);
...
fprintf(out_file, "int weights_array[%d] = {\n",TOTAL_WEIGHTS);

for(int i=0;i<TOTAL_WEIGHTS;i++)
{
  if(i!=TOTAL_WEIGHTS-1)
    fprintf(out_file, "%d,",weights_array[i]);
  else 
    fprintf(out_file, "%d\n};\n",weights_array[i]);
}

fprintf(out_file, "int weights_array0[%d] = {\n",9*3);
...
fprintf(out_file, "int alpha1_array[%d] = {\n",TOTAL_NODES);

for(int i=0;i<TOTAL_NODES;i++)
{
  if(i!=TOTAL_NODES-1)
    fprintf(out_file, "%d,",alpha1_array[i]);
  else 
    fprintf(out_file, "%d\n};\n",alpha1_array[i]);
}

fprintf(out_file, "int alpha1_array0[%d] = {\n",9);
...
fprintf(out_file, "int alpha2_array[%d] = {\n",TOTAL_NODES);

for(int i=0;i<TOTAL_NODES;i++)
{
  if(i!=TOTAL_NODES-1)
    fprintf(out_file, "%d,",alpha2_array[i]);
  else 
    fprintf(out_file, "%d\n};\n",alpha2_array[i]);
}

fprintf(out_file, "int alpha2_array0[%d] = {\n",9);
...
fprintf(out_file, "int tree_thresh_array[%d] = {\n",TOTAL_NODES);

for(int i=0;i<TOTAL_NODES;i++)
{
  if(i!=TOTAL_NODES-1)
    fprintf(out_file, "%d,",tree_thresh_array[i]);
  else 
    fprintf(out_file, "%d\n};\n",tree_thresh_array[i]);
}

fprintf(out_file, "int tree_thresh_array0[%d] = {\n",9);
...
fprintf(out_file, "int stages_thresh_array[%d] = {\n",TOTAL_STAGES);

for(int i=0;i<TOTAL_STAGES;i++)
{
  if(i!=TOTAL_STAGES-1)
    fprintf(out_file, "%d,",stages_thresh_array[i]);
  else 
